    ...
    <Grid>
        <TabControl Name="tabControl" HorizontalAlignment="Left" Height="345" Margin="10,10,0,0" VerticalAlignment="Top" Width="509">
            ...
            <TabItem Header="Reports">
                <Grid Background="#FFE5E5E5">
                    <Image Name="image1" HorizontalAlignment="Left" Height="213" Margin="10,10,0,0" VerticalAlignment="Top" Width="483" Source="C:\Users\jadkin\Pictures\pluralsight-logo.png" Stretch="UniformToFill"/>
                    <Label Name="label4" Content="Enter RITM NUmber and click start to run the program" HorizontalAlignment="Left" Height="26" Margin="30,226,0,0" VerticalAlignment="Top" Width="451"/>
                    <Label Name="label5" Content="RITM Number:" HorizontalAlignment="Left" Height="33" Margin="30,263,0,0" VerticalAlignment="Top" Width="109"/>
                    <TextBox Name="RITMNumber2" HorizontalAlignment="Left" Height="32" Margin="147,264,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="224"/>
                    <Button Name="Start2" Content="Start" HorizontalAlignment="Left" Height="31" Margin="380,265,0,0" VerticalAlignment="Top" Width="101"/>
                </Grid>
            </TabItem>
        </TabControl>
